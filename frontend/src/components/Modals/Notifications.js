...
class Notifications extends Component {
  ...
  render() {
    ...
    var notificationClass = seenComments.length > 0 || seenFavorites.length > 0 || seenFollowers.length >  0 || seenPotluckInvitation.length > 0? "button formButton alert": "button formButton";
    return (
      <div className="Modal">
        <div>
