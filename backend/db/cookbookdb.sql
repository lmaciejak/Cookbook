...
INSERT INTO recipes (user_id, recipe_name, recipe, img, description, isVegeterian, isVegan, fork)
  ...
  'https://pioneerwoman.files.wordpress.com/2014/07/dsc_35621.jpg', 'some description', false, false, true),
   ...
   false, false, false),
    (1, 'Grilled Salmon', 'Grill Salmon', 'https://images.pexels.com/photos/46239/salmon-dish-food-meal-46239.jpeg?w=1260&h=750&dpr=2&auto=compress&cs=tinysrgb', 'some description',false, false, true),
